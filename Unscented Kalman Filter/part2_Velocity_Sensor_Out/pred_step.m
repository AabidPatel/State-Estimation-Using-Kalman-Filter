...
%% BEFORE RUNNING THE CODE CHANGE NAME TO pred_step
    ...
    covar_aug = [covarPrev,zeros(15,12); zeros(12,15),dt*0.001*eye(12)];
    ...
    for j = 1:55
        ...
        wm_x = angVel(1,1); wm_y = angVel(2,1); wm_z = angVel(3,1); am_x = acc(1,1); am_y = acc(2,1); am_z = acc(3,1); wm = [wm_x; wm_y; wm_z]; am = [am_x; am_y; am_z];
